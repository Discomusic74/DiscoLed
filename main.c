...
int main(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM3, ENABLE);  // Timer2
  ...
  tim3_base.TIM_Period = 4200;
  tim3_base.TIM_ClockDivision = TIM_CKD_DIV1;
  TIM_TimeBaseInit(TIM4,&tim3_base);
...
void DMA1_Stream7_IRQHandler(void){
  ...
  //for(uint32_t i = 0; i < 25*10; i++) { Delay(50000L); }
